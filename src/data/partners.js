 ...
 * 2. Run scripts/standardize-logos.py to normalize the canvas (600x200 with
 *    visible content fitted into a 560x160 inner box). This ensures every
 *    logo displays at a consistent visual size in the banner.
 * 3. Add a new entry to the relevant array below.
 *
 * FIELDS:
